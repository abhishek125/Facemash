...
<img class="img-responsive myimage" alt="myimage"
         ...
         <div class="username">
          ...
          <!-- <a href="https://web.facebook.com/myimage" target="_blank"
           ...
           <button type="button" value="${request}"
                ...
                onclick="sendRequest(this,this.value,'${user.userId}')"><i class="fa fa-user-plus"></i>
       ...
       <li class="default open">
        <div class="link">
         <i class="fa fa-picture-o"></i>User's Photos <i
       ...
       <li class="default open">
        <div class="link">
         <i class="fa fa-users"></i>User's Friends <i
          class="fa fa-chevron-down"></i>
        </div>
        <ul class="submenu">
...
<div class="col-sm-6">
       ...
       <div class="panel panel-default">
        <div class="panel-heading">
         ...
         <h4><a href="${pageContext.request.contextPath}/profile/${activity.profile.userId}">
         ${activity.profile.firstname} ${activity.profile.lastname} ${text}</a></h4>
        </div>
    ...
    <a class="right carousel-control" href="#image${activity.activityId}" data-slide="next" style="height:300px;">
      ...
      <span class="sr-only">Next</span>
        ...
        <div id="video${activity.product.productId}" class="carousel slide" data-interval="false" >
        ...
        <div style="margin-bottom: 20px;">
         <button class="btn  btn-primary ${activity.product.productId}likebtn" style="margin-left: 30px;" value="${liked}"  onclick="updateProduct('${activity.product.productId}',this.value)" >
          <i class="fa fa-thumbs-up ${activity.product.productId}likesign" id="" >${liked}</i> <span class="badge ${activity.product.productId}like" >${activity.product.likes}</span>
         </button>

         <button class="btn  btn-success" style="margin-left: 30px;" onclick="showComments('${activity.activityId}')" >
          <i class="fa fa-comment">comment</i> <span class="badge ${activity.product.productId}comment" >${activity.product.comments}</span>
         </button>
         <button class="btn  btn-info ${activity.product.productId}sharebtn" style="margin-left: 30px;" value="${shared}"  onclick="updateProduct('${activity.product.productId}',this.value)">
          <i  class="fa fa-share ${activity.product.productId}sharesign">${shared}</i> <span class="badge ${activity.product.productId}share" >${activity.product.shares}</span>
         </button>
        </div>
       ...
       <div class="panel panel-default">
        <div class="panel-heading">
         <span class="pull-right"> ${activity.date} </span>
         <h4><a href="${pageContext.request.contextPath}/profile/${activity.profile.userId}">
         ${activity.profile.firstname} ${activity.profile.lastname} commented on a post</a></h4>
        </div>
        <div class="panel-body">
         ${activity.product.textData} 
         <div id="image${activity.activityId}" class="carousel slide" data-interval="false" >
  ...
  <!--    <div id="show-more">
         ...
         <input type="hidden" name="${_csrf.parameterName}"
       value="${_csrf.token}">
          <input class="send-button"  id="${activity.product.productId}commentform" value="done" type="button" onclick=
          "submitComment(this.id,'${loggedInUser.profilePic}','${loggedInUser.firstname} ${loggedInUser.lastname}',
          '${activity.activityId}')">
          </form>
        </div>
        </div>
       ...
       <div style="text-align: center;"><strong>no more feeds from this user</strong></div>
</div>
