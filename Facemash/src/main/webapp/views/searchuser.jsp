							...
							<ul id="accordion" class="accordion">
								...
								<li class="default open">
									<div class="link">
										...
										Photos
										<small>${fn:length(products)}</small>
										<i class="fa fa-chevron-down"></i>
									</div>
									<ul class="submenu">
										<li class="photos">
									...
									<c:forEach var="user" items="${users}">
										<div>
											<table>
												<tr>
													<td width="400px">
														<img src="${user.profilePic}" class="addfrndimg" />
														<span>
															<strong>
