		...
		<div class="row" id="pwd-container">
			...
			<div class="col-md-4">
				<section class="login-form">
					<form name="f" method="post" action="${pageContext.request.contextPath}/" role="login">
						<img src="${pageContext.request.contextPath}/resources/images/company.png" class="img-responsive" alt="" />
