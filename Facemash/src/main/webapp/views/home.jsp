				...
				<div class="full col-sm-12">
					...
					<div class="row">
						<div class="col-sm-3" id="sidebar">
							<ul id="sidebar" class="nav nav-pills nav-stacked" style="max-width: 330px; color: black;">
								<li>
						...
						<div class="col-sm-6">
							<div class="well">
								<form class="form-horizontal" method="post" role="form" id="statusForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/post">
									<h4>What's New</h4>
									<div class="form-group" style="padding: 14px;">
										<textarea class="form-control" placeholder="Update your status" id="status"></textarea>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="main-holder ${activity.product.productId}commentsection" id="${activity.activityId}commentsection" style="display: none;">
											<div id="show-more">
												<span>
													<button class="btn btn-link" onclick="otherComments('${activity.activityId}')">show more comments</button>
											...
											<div>
												...
												<form>
													...
													<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
													<input class="send-button" id="${activity.activityId}" value="done" type="button" onclick="submitComment('${activity.product.productId}commentform','${profile.profilePic}','${profile.firstname} ${profile.lastname}','${activity.activityId}')">
												</form>
											</div>
										</div>
									</div>
										...
										<div class="main-holder ${activity.product.productId}commentsection" id="${activity.activityId}commentsection" style="display: none;">
											...
											<div>
												...
												<form>
													<textarea id="${activity.activityId}commentarea" class="lightText commentarea"></textarea>
													<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
													<input class="send-button" id="${activity.product.productId}commentform" value="done" type="button" onclick="submitComment(this.id,'${profile.profilePic}','${profile.firstname} ${profile.lastname}','${activity.activityId}')">
												</form>
											</div>
										</div>
									</div>
							...
							<div style="text-align: center;">
								<strong>no more feeds add more friends to get more feeds</strong>
							</div>
						</div>
						<!-- main col right -->
						<div class="col-sm-3">
									...
									<div class="uk-input-group">
										<div class="gurdeep-chat-box">
											...
											<span style="display: inline; float: right;" class="uk-input-group-addon">
												<textarea placeholder="Type a message" height="50px" id="submit_message" name="submit_message" class="md-input"></textarea>
												<a href="#">
