     ...
     <div class="row">
      <div class="col-sm-3" id="sidebar">
       ...
       <ul id="accordion" class="accordion">
        ...
        <li class="default open">
         <div class="link">
          <i class="fa fa-picture-o"></i>Photos<i
        ...
        <li class="default open">
         <div class="link">
          <i class="fa fa-users"></i>Friends <i
           class="fa fa-chevron-down"></i>
         </div>
         <ul class="submenu">
         ...
         <div class="custom1">
          <div class="col-lg-12 col-md-12 col-sm-12">
           <input type="file" id="main-input"
            class="form-control form-input form-style-base" name="file">
           <h4 id="fake-btn"
            class="form-input fake-styled-btn text-center truncate">
      ...
      <div class="col-sm-5">
       <div class="gear">
        <label>First Name:</label> <span id="firstname" class="datainfo">${profile.firstname}
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       </div>
       <div class="gear">
        <label>last Name:</label> <span id="lastname" class="datainfo">${profile.lastname}</span>
        <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       </div>
       <div class="gear">
        <label>your email:</label> <span id="mail" class="datainfo">${profile.mail}</span>
        <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       </div>
       <div class="gear">
        <label>password:</label> <span id="password" class="datainfo">***********</span>
        <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       </div>
       <div class="gear">
        <label>date of birth:</label> <span id="dob" class="datainfo">${myVar}</span>
        <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       </div>
       <div class="gear">
        <label>Gender:</label> <span id="gender" class="datainfo">${profile.gender}</span>
        <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       </div>
       ...
       <div class="gear">
        <label>highschool:</label> <span id="highSchool"
         class="datainfo ${name}"> <c:if
          test="${empty profile.highSchool}">
    where you studied at highschool?
</c:if> <c:if test="${not empty profile.highSchool}">
    ${profile.highSchool}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>college:</label> <span id="college"
         class="datainfo ${name}"> <c:if
          test="${empty profile.college}">
    where is your college?
</c:if> <c:if test="${not empty profile.college}">
    ${profile.college}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>work:</label> <span id="work" class="datainfo ${name}">
         <c:if test="${empty profile.work}">
    where do you work?
</c:if> <c:if test="${not empty profile.work}">
    ${profile.work}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>about:</label> <span id="about" class="datainfo ${name}">
         <c:if test="${empty profile.about}">
    write something about yourself.
</c:if> <c:if test="${not empty profile.about}">
    ${profile.about}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>quote:</label> <span id="quote" class="datainfo ${name}">
         <c:if test="${empty profile.quote}">
    what is your favourite quote?
</c:if> <c:if test="${not empty profile.quote}">
    ${profile.quote}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>interest:</label> <span id="interest"
         class="datainfo ${name}"> <c:if
          test="${empty profile.interest}">
    what is your interest?
</c:if> <c:if test="${not empty profile.interest}">
    ${profile.interest}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>religious:</label> <span id="religious"
         class="datainfo ${name}"> <c:if
          test="${empty profile.religious}">
    what is your religious view?
</c:if> <c:if test="${not empty profile.religious}">
    ${profile.religious}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>phone:</label> <span id="phone" class="datainfo ${name}">
         <c:if test="${empty profile.phone}">
    what is your phone number?
</c:if> <c:if test="${not empty profile.phone}">
    ${profile.phone}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>currentcity:</label> <span id="currentCity"
         class="datainfo ${name}"> <c:if
          test="${empty profile.currentCity}">
    where do you live?
</c:if> <c:if test="${not empty profile.currentCity}">
    ${profile.currentCity}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>hometown:</label> <span id="homeTown"
         class="datainfo ${name}"> <c:if
          test="${empty profile.homeTown}">
    where is your hometown?
</c:if> <c:if test="${not empty profile.homeTown}">
    ${profile.homeTown}
</c:if>
        </span> <a href="#" class="editlink">Edit Info</a> <a class="savebtn">Save</a><a
         class="cancelbtn">cancel</a>
       ...
       <div class="gear">
        <label>relationstatus:</label> <span id="relationStatus"
         class="datainfo ${name}"> <c:if
          test="${empty profile.relationStatus}">
    what is your relation status?
</c:if> <c:if test="${not empty profile.relationStatus}">
...
<div class="fix" id="sidebar_secondary">
    ...
    float: right;"  class="uk-input-group-addon"><textarea placeholder="Type a message" style="height:50px;"
  ...
  <!-- /main -->
<div style="display:none;" id="main-inputUploadSection"></div><!-- dont delete this div else listfiles() will cause error -->
 </div>
 <!--row-->
</body>
</html>
